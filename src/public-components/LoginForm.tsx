...
const loginSchema = z.object({
  ...
  Password: z
    ...
    .min(6, { message: 'Password must be longer than 6 letters!' }),
});
  ...
  return (
    <>
      {isOpen ? (
        <Button
          isDisabled
          className="signUp-openForm-button"
          onPress={handleOpenLogin}
        >
          Login
        </Button>
      ) : (
        <Button className="signUp-openForm-button" onPress={handleOpenLogin}>
          Login
        </Button>
      )}
      {isOpen && (
        ...
        >
          <Button
            className="signUp-closeForm-button"
